...
% TODO fazer uma breve introdução sobre a história de jogos em geral. 

%% ------------------------------------------------------------------------- %%
\section{Jogos Moveis}
\label{sec:jogos_moveis}

% TODO Fazer um estudo mais aprofundado sobre jogos moveis. 
...
TODO Fazer um estudo mais aprofundado sobre jogos multijogador
