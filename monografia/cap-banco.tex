...
banco de dados: 
\begin{itemize}
\item{\textbf{ModeloFisico}} - O arquivo ModeloFisico.sql executa toda a criação de toda a estrutura (tabelas, chaves primárias, chaves estrangeiras, etc) presentes no banco de dados de Biografia.
